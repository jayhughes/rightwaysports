 ...
 */
    ...
    function defaultPrefilter(elem, props, opts) {
        ...
        "inline" === checkDisplay && "none" === jQuery.css(elem, "float") && (// inline-level elements accept inline-block;
        // block-level elements need to be inline with layout
        support.inlineBlockNeedsLayout && "inline" !== defaultDisplay(elem.nodeName) ? style.zoom = 1 : style.display = "inline-block")), 
 ...
 */
	...
	---------------------------------------------------------------------- */
            ...
            documentIsHTML = !isXML(doc), support.attributes = assert(function(div) {
                ...
                div.querySelectorAll("[id~=" + expando + "-]").length || rbuggyQSA.push("~="), // Webkit/Opera - :checked should return selected option elements
                // http://www.w3.org/TR/2011/REC-css3-selectors-20110929/#checked
                // IE8 throws error here and will not see later tests
                div.querySelectorAll(":checked").length || rbuggyQSA.push(":checked"), // Support: Safari 8+, iOS 8+
 ...
 */
    ...
    jQuery(function() {
        ...
        body = document.getElementsByTagName("body")[0], body && body.style && (// Setup
        div = document.createElement("div"), container = document.createElement("div"), 
        container.style.cssText = "position:absolute;border:0;width:0;height:0;top:0;left:-9999px", 
        body.appendChild(container).appendChild(div), typeof div.style.zoom !== strundefined && (// Support: IE<8
        // Check if natively block-level elements act like inline-block
        // elements when setting their display to 'inline' and giving
        // them layout
        div.style.cssText = "display:inline;margin:0;border:0;padding:1px;width:1px;zoom:1", 
        support.inlineBlockNeedsLayout = val = 3 === div.offsetWidth, val && (// Prevent IE 6 from affecting layout for positioned elements #11048
 ...
 */
    ...
    !function() {
        ...
        for (i in {
            ...
            change: !0,
            focusin: !0
        }) eventName = "on" + i, (support[i + "Bubbles"] = eventName in window) || (// Beware of CSP restrictions (https://developer.mozilla.org/en/Security/CSP)
        div.setAttribute(eventName, "t"), support[i + "Bubbles"] = div.attributes[eventName].expando === !1);
        // Null elements to avoid leaks in IE.
        div = null;
    }();
 ...
 */
    ...
    wrapMap.th = wrapMap.td, jQuery.extend({
        ...
        buildFragment: function(elems, context, scripts, selection) {
            ...
            if ("object" === jQuery.type(elem)) jQuery.merge(nodes, elem.nodeType ? [ elem ] : elem); else if (rhtml.test(elem)) {
                ...
                elem = "table" !== tag || rtbody.test(elem) ? // String was a bare <thead> or <tfoot>
                "<table>" !== wrap[1] || rtbody.test(elem) ? 0 : tmp : tmp.firstChild, j = elem && elem.childNodes.length; j--; ) jQuery.nodeName(tbody = elem.childNodes[j], "tbody") && !tbody.childNodes.length && elem.removeChild(tbody);
                // Fix #12392 for oldIE
            ...
            return access(this, function(value) {
                ...
                if ("string" == typeof value && !rnoInnerhtml.test(value) && (support.htmlSerialize || !rnoshimcache.test(value)) && (support.leadingWhitespace || !rleadingWhitespace.test(value)) && !wrapMap[(rtagName.exec(value) || [ "", "" ])[1].toLowerCase()]) {
                    ...
                    try {
                        ...
                        elem = this[i] || {}, 1 === elem.nodeType && (jQuery.cleanData(getAll(elem, !1)), 
        ...
        domManip: function(args, callback) {
            ...
            first)) {
                ...
                hasScripts && jQuery.merge(scripts, getAll(node, "script"))), callback.call(this[i], node, i);
                ...
                rscriptType.test(node.type || "") && !jQuery._data(node, "globalEval") && jQuery.contains(doc, node) && (node.src ? // Optional AJAX dependency, but won't run scripts if not present
                jQuery._evalUrl && jQuery._evalUrl(node.src) : jQuery.globalEval((node.text || node.textContent || node.innerHTML || "").replace(rcleanScript, "")));
    ...
    window.getComputedStyle ? (getStyles = function(elem) {
        ...
        function computeStyleTests() {
            ...
            div = document.createElement("div"), container = document.createElement("div"), 
            container.style.cssText = "position:absolute;border:0;width:0;height:0;top:0;left:-9999px", 
            body.appendChild(container).appendChild(div), div.style.cssText = // Support: Firefox<29, Android 2.3
            // Vendor-prefix box-sizing
            "-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;display:block;margin-top:1%;top:1%;border:1px;padding:1px;width:4px;position:absolute", 
            // Support: IE<9
            // Assume reasonable values in the absence of getComputedStyle
            pixelPositionVal = boxSizingReliableVal = !1, reliableMarginRightVal = !0, // Check for getComputedStyle so that this code is not run in IE<9.
            ...
            div.removeChild(contents)), // Support: IE8
        ...
        a = div.getElementsByTagName("a")[0], style = a && a.style, // Finish early in limited (non-browser) environments
        style && (style.cssText = "float:left;opacity:.5", // Support: IE<9
        // Make sure that element opacity exists (as opposed to filter)
        support.opacity = "0.5" === style.opacity, // Verify style float existence
        // (IE uses styleFloat instead of cssFloat)
        support.cssFloat = !!style.cssFloat, div.style.backgroundClip = "content-box", div.cloneNode(!0).style.backgroundClip = "", 
        support.clearCloneStyle = "content-box" === div.style.backgroundClip, // Support: Firefox<29, Android 2.3
        // Vendor-prefix box-sizing
    ...
    jQuery.extend({
        ...
        style: function(elem, name, value, extra) {
            ...
            if (elem && 3 !== elem.nodeType && 8 !== elem.nodeType && elem.style) {
                ...
                // Fixes bug #9237
                type = "number"), null != value && value === value && (// If a number was passed in, add 'px' to the (except for certain CSS properties)
                "number" !== type || jQuery.cssNumber[origName] || (value += "px"), // Fixes #8908, it can be done more correctly by specifing setters in cssHooks,
        ...
        set: function(elem, value) {
            ...
            (value >= 1 || "" === value) && "" === jQuery.trim(filter.replace(ralpha, "")) && style.removeAttribute && (// Setting style.filter to null, "" & " " still leave "filter:" in the cssText
    ...
    jQuery.fn.delay = function(time, type) {
        ...
        input = div.getElementsByTagName("input")[0], a.style.cssText = "top:1px", // Test setAttribute on camelCase class. If it works, we need attrFixes when doing get/setAttribute (ie6/7)
        support.getSetAttribute = "t" !== div.className, // Get the style information from getAttribute
        // (IE uses .cssText instead)
        support.style = /top/.test(a.getAttribute("style")), // Make sure that URLs aren't manipulated
        // (IE normalizes it by default)
        support.hrefNormalized = "/a" === a.getAttribute("href"), // Check the default checkbox/radio value ("" on WebKit; "on" elsewhere)
        ...
        select.disabled = !0, support.optDisabled = !opt.disabled, // Support: IE8 only
    ...
    jQuery.fn.extend({
        ...
        removeAttr: function(elem, value) {
            ...
            getSetInput && getSetAttribute || !ruseDefault.test(name) ? elem[propName] = !1 : elem[jQuery.camelCase("default-" + name)] = elem[propName] = !1 : jQuery.attr(elem, name, ""), 
            ...
            return {
                send: function(headers, complete) {
                    ...
                    callback = function(_, isAbort) {
                        ...
                        if (callback && (isAbort || 4 === xhr.readyState)) // Abort manually if needed
                        if (// Clean up
                        delete xhrCallbacks[id], callback = void 0, xhr.onreadystatechange = jQuery.noop, 
                        isAbort) 4 !== xhr.readyState && xhr.abort(); else {
                            responses = {}, status = xhr.status, // Support: IE<10
                    ...
                    }, options.async ? 4 === xhr.readyState ? // (IE6 & IE7) if it's in cache and has been
                    // retrieved directly we need to fire the callback
                    setTimeout(callback) : // Add to the list of active xhr callbacks
                    xhr.onreadystatechange = xhrCallbacks[id] = callback : // if we're in sync mode we fire the callback
                    callback();
                },
                abort: function() {
            ...
            return {
                send: function(_, callback) {
                    ...
                    script.onload = script.onreadystatechange = function(_, isAbort) {
                        ...
                        script.parentNode && script.parentNode.removeChild(script), // Dereference the script
